...
struct NewEntryView: View {
    ...
    private func save() {
        ...
        let entry = Entry(project: project, tags: selectedTags, notes: notes, startDate: startDate, endDate: showEndDate ? endDate : nil)
...
#Preview {
    NewEntryView()
        .modelContainer(for: [Entry.self, Project.self, Tag.self], inMemory: true)
}
